...
public final class EntityRegister {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static void registerEntity(final String name, final EntityType type, final Class<? extends Entity> customClass, boolean biomes) {
		...
		try {
			field.setAccessible(true);
			for (BiomeBase base : BiomeBase.i) {
				final List<BiomeMeta> list = (List<BiomeMeta>) field.get(base);
	...
	public static org.bukkit.entity.Entity spawnBot( Location location ) {
		WorldServer world = ( ( CraftWorld ) location.getWorld() ).getHandle();
		Entity customEntity = new GunBot( world );
	...
	public enum Biome {
		...
		FLOWER_FOREST(BiomeFlowerForest.class),
	...
	public static enum Attributes {
		MAX_HEALTH("generic.maxHealth", GenericAttributes.MAX_HEALTH),
		KNOCKBACK_RESISTANCE("generic.knockbackResistance", GenericAttributes.KNOCKBACK_RESISTANCE),
		...
		ARMOR("generic.armor", GenericAttributes.ARMOR),
		ARMOR_TOUGHNESS("generic.armorToughness", GenericAttributes.ARMOR_TOUGHNESS),
		ATTACK_SPEED("generic.attackSpeed", GenericAttributes.ATTACK_SPEED),
		LUCK("generic.luck", GenericAttributes.LUCK),
	...
	public static class SpawnData extends BiomeMeta {
		 ...
		 */
		public SpawnData( EntityTypes< ? > entityType, final int spawnWeight, final int minSpawns,
				final int maxSpawns) {
			super(entityType, spawnWeight, minSpawns, maxSpawns);
		}
	}
